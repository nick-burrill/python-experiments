...
with open(csvFile, 'w', newline='') as file:
    ...
    writer.writerow(["Name", "Price", "Volume", "Alcohol %", "Location", "Made by", "Sugar content", "Sweetness discriptor", "Style","Variety"])
    print("[green] ...Done![/green]")
while pageNum <= pageMax:
    beginIndex = "beginIndex=" + str((pageNum*12)-12) # pg# = (n*12)-12
    url  = "https://www.lcbo.com/webapp/wcs/stores/servlet/en/lcbo/" + department + "?" + pageView + "&" + orderBy + "&" + beginIndex
        ...
        for li in item.select("div.productChart div a"):
            ...
            if(len(infoList) >= 3):
                ...
                if(type(tempString) is str):
                    tempString = tempString.replace(u'\xa0', u' ')
